...
@RunWith(Suite.class)
@SuiteClasses({
      ConsumerBodyDataMappingTest.class, ConsumerHeaderDataMappingTest.class,
      ConsumerGeneralConfigurationTest.class, ConsumerIncludeConverterTest.class})
public class ConsumerApplicationTestSuite
{
   ...
   private static String[] deployedModels = {"GenericApplicationConsumerTestModel"};
