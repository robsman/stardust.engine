...
@RunWith(Suite.class)
@SuiteClasses({
      ProducerBodyDataMappingTest.class, ProducerHeaderDataMappingTest.class,
      ProducerGeneralConfigurationTest.class, IncludeHeadersStrategyTest.class,
      ProducerIncludeConverterTest.class})
public class ProducerApplicationTestSuite
{
   ...
   private static String[] deployedModels = { "Camel_Application_type", "GenericApplicationProducerTestModel", "CsvConverterModelTest" };
