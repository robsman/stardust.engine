...
public class TypeConverterComponentTest
{

   private static ClassPathXmlApplicationContext ctx;
   {
      ctx = new ClassPathXmlApplicationContext(new String[] {
            "org/eclipse/stardust/engine/extensions/camel/converter/TypeConverterComponentTest-context.xml",
      ...
      ClassPathResource resource = new ClassPathResource("models/BpmTypeConverterTestUsingIPPEndpointModel.xpdl");
