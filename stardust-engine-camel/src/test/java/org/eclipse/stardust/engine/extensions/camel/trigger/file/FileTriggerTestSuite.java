...
@RunWith(Suite.class)
@SuiteClasses({
      FileTriggerBodyDataMappingTest.class, FileTriggerHeaderDataMappingTest.class,
      FileTriggerIncludeSplitterTest.class, FileTriggerIncludeConverterTest.class})
public class FileTriggerTestSuite
{
   ...
   private static String[] deployedModels = {"FileTriggerTestModel"};
