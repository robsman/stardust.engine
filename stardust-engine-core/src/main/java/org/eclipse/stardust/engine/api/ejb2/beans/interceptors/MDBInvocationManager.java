...
public class MDBInvocationManager extends InvocationManager
{
   ...
   {
      super(serviceInstance, setupInterceptors(serviceName, context, nRetries, msPause,
            rollbackOnError));
   }
         ...
         MessageDrivenContext context, int nRetries, int msPause, boolean rollbackOnError)
   {
      ...
      interceptors.add(new ContainerConfigurationInterceptor(serviceName, J2eeContainerType.EJB));
