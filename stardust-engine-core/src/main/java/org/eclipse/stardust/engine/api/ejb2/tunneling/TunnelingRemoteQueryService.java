 ...
 *
 */
public interface TunnelingRemoteQueryService extends javax.ejb.EJBObject, org.eclipse.stardust.engine.api.ejb2.tunneling.TunnelingRemoteService
{
    ...
    *    trail.
    *
    * @return a List of {@link org.eclipse.stardust.engine.api.runtime.ActivityInstance
    ...
    *
    * @deprecated Use {@link #getModels(org.eclipse.stardust.engine.api.query.DeployedModelQuery)
    ...
    *
    * @throws org.eclipse.stardust.common.error.ObjectNotFoundException if there is no model with the
    *    specified OID.
    *     <em>Instances of {@link org.eclipse.stardust.common.error.ObjectNotFoundException} will
    *    be wrapped inside {@link org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws org.eclipse.stardust.common.error.WorkflowException as a wrapper for
    ...
    *
    * @return a List of {@link org.eclipse.stardust.engine.api.model.ProcessDefinition
    ...
    * @param modelOID the oid of the model.
    *
    * @return a List of {@link org.eclipse.stardust.engine.api.model.Participant Participant}
    *    objects.
    *
    * @throws org.eclipse.stardust.common.error.ObjectNotFoundException if there is no model with the
    *    specified oid.
    ...
    *       org.eclipse.stardust.engine.api.runtime.DocumentManagementService#findDocuments(
    *    org.eclipse.stardust.engine.api.query.DocumentQuery)
    ...
    *
    * @throws org.eclipse.stardust.common.error.PublicException if querying is not supported for the
    *    specified PreferenceScope.
    *     <em>Instances of {@link org.eclipse.stardust.common.error.PublicException} will be
    *    wrapped inside {@link org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws java.lang.UnsupportedOperationException if the PreferenceQuery contains unsupported
    *    terms or operations.
    *     <em>Instances of {@link java.lang.UnsupportedOperationException} will be wrapped inside
    *    {@link org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws org.eclipse.stardust.common.error.InvalidArgumentException if <tt>preferencesQuery</tt>
    *    is null.
