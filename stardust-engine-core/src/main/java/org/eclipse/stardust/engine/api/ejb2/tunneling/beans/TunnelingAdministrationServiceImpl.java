...
public class TunnelingAdministrationServiceImpl extends org.eclipse.stardust.engine.api.ejb2.tunneling.beans.AbstractTunnelingServiceImpl
{
    ...
    *    warning
    *
    * @throws org.eclipse.stardust.engine.api.runtime.DeploymentException Exception if the overwrite
    ...
    *    DeploymentElement.
    *
    * @throws org.eclipse.stardust.engine.api.runtime.DeploymentException if the deployment operation
    *    could not be performed.
    *     <em>Instances of {@link org.eclipse.stardust.engine.api.runtime.DeploymentException}
    *    will be wrapped inside {@link
    *    org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws org.eclipse.stardust.common.error.InvalidArgumentException if the deploymentElements
    *    argument is null.
    ...
    *     <em>Instances of {@link org.eclipse.stardust.common.error.ConcurrencyException} will be
    ...
    * 
    * <p>If <i>implementationModelId</i> is <code>null</code> the default implementation will
    * be reset
    ...
    *     <em>Instances of {@link org.eclipse.stardust.common.error.ObjectNotFoundException} will
    ...
    * for it.
    * If the process instance is not yet inserted in the database but needs to be aborted for
    * some reason ( e.g. by abort process event)
    ...
    *     <em>Instances of {@link org.eclipse.stardust.common.error.ObjectNotFoundException} will
    *    be wrapped inside {@link org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws org.eclipse.stardust.engine.api.runtime.IllegalOperationException if the oid references
    ...
    * By default the execution is synchronous. Asynchronous successor attempts to recover the
    * affected
    ...
    * of daemon types.The stop daemon operation is inherently asynchronous, regardless of the
    * acknowledge flag.
    ...
    * predetermined (configurable)
    * amount of time for the asynchronous daemon to confirm the execution of the operation.
    * If acknowledge is false then the method will return immediately, without status updates
    * to the returned object.
    * Otherwise it will wait for the executor thread to confirm the action.
    * The acknowledge flag allows to wait for the executor to confirm the actual start of the
    * daemon.
    * The status object is not influenced by this flag.
    *
    ...
    *    org.eclipse.stardust.engine.api.runtime.IllegalStateChangeException} will be wrapped
    *    inside {@link org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws org.eclipse.stardust.common.error.AccessForbiddenException if the current user does not
    ...
    *
    * @exception org.eclipse.stardust.common.error.ObjectNotFoundException if there is no runtime object
    ...
    *     <em>Instances of {@link
    *    org.eclipse.stardust.engine.api.runtime.DepartmentExistsException
    *    } will be wrapped inside {@link
    *    org.eclipse.stardust.common.error.WorkflowException}.</em>
    ...
    *     <em>Instances of {@link org.eclipse.stardust.common.error.PublicException} will be
    *    wrapped inside {@link org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws org.eclipse.stardust.common.error.WorkflowException as a wrapper for
    *         org.eclipse.stardust.common.error.PublicExceptions and org.eclipse.stardust.common.error.ResourceExceptions
    *
    ...
    *    will be wrapped inside {@link
    *    org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws org.eclipse.stardust.common.error.InvalidArgumentException if <tt>preferences</tt> is
    *    null.
    *     <em>Instances of {@link org.eclipse.stardust.common.error.InvalidArgumentException}
    *    will be wrapped inside {@link
    *    org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws org.eclipse.stardust.common.error.InvalidArgumentException if preferences property
    *    <tt>preferences</tt> is null.
    *     <em>Instances of {@link org.eclipse.stardust.common.error.InvalidArgumentException}
    *    will be wrapped inside {@link
    *    org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws org.eclipse.stardust.common.error.InvalidArgumentException if preferences property
    *    <tt>moduleId</tt> is null or empty.
    *     <em>Instances of {@link org.eclipse.stardust.common.error.InvalidArgumentException}
    *    will be wrapped inside {@link
    *    org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws org.eclipse.stardust.common.error.InvalidArgumentException if preferences property
    *    <tt>preferencesId</tt> is null or empty.
    *     <em>Instances of {@link org.eclipse.stardust.common.error.InvalidArgumentException}
    *    will be wrapped inside {@link
    *    org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws org.eclipse.stardust.common.error.WorkflowException as a wrapper for
    ...
    *    model versions.
    *
    * @throws org.eclipse.stardust.common.error.InvalidArgumentException if <tt>modelId</tt> is null
    *    or empty.
    *     <em>Instances of {@link org.eclipse.stardust.common.error.InvalidArgumentException}
    *    will be wrapped inside {@link
    *    org.eclipse.stardust.common.error.WorkflowException}.</em>
    ...
    *
    * @throws org.eclipse.stardust.common.error.InvalidArgumentException if <tt>modelIds</tt> is null
    *    or contains an modelId which is null or empty.
    *     <em>Instances of {@link org.eclipse.stardust.common.error.InvalidArgumentException}
    *    will be wrapped inside {@link
    *    org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws org.eclipse.stardust.common.error.WorkflowException as a wrapper for
    ...
    *    will be wrapped inside {@link
    *    org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws org.eclipse.stardust.common.error.InvalidArgumentException if
    *    <tt>configurationVariables</tt> is null.
    *     <em>Instances of {@link org.eclipse.stardust.common.error.InvalidArgumentException}
    *    will be wrapped inside {@link
    *    org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws org.eclipse.stardust.common.error.WorkflowException as a wrapper for
    ...
    *    will be wrapped inside {@link
    *    org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws org.eclipse.stardust.common.error.InvalidArgumentException if <tt>permissions</tt> is
    *    null.
    *     <em>Instances of {@link org.eclipse.stardust.common.error.InvalidArgumentException}
    *    will be wrapped inside {@link
    *    org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws org.eclipse.stardust.common.error.ValidationException if changed grants are not valid
    *    in the active model.
    *     <em>Instances of {@link org.eclipse.stardust.common.error.ValidationException} will be
    *    wrapped inside {@link org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws org.eclipse.stardust.common.error.WorkflowException as a wrapper for
    *         org.eclipse.stardust.common.error.PublicExceptions and org.eclipse.stardust.common.error.ResourceExceptions
    *
    ...
    * <p>
    * 
    * The {@link org.eclipse.stardust.engine.api.runtime.ArtifactType#getId()
    * ArtifactType.getId()}
    * is used to identify the {@link org.eclipse.stardust.engine.api.runtime.ArtifactType
    * ArtifactType} for a
    ...
    *
    * @throws org.eclipse.stardust.common.error.ObjectExistsException if another link type with the
    *    same id already exists.
    *     <em>Instances of {@link org.eclipse.stardust.common.error.ObjectExistsException} will
    *    be wrapped inside {@link org.eclipse.stardust.common.error.WorkflowException}.</em>
    * @throws org.eclipse.stardust.common.error.WorkflowException as a wrapper for
    *         org.eclipse.stardust.common.error.PublicExceptions and org.eclipse.stardust.common.error.ResourceExceptions
    *
