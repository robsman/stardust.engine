...
public class TunnelingDocumentManagementServiceImpl extends org.eclipse.stardust.engine.api.ejb2.tunneling.beans.AbstractTunnelingServiceImpl
{
   ...
   /**
    * Initiates document content download via {@link
    * org.eclipse.stardust.engine.api.web.dms.DmsContentServlet DmsContentServlet}. The
    ...
    * full content will be materialized in memory both on the server as well as on the
    * client. It is recommended to us the facilities provided by
    * {@link org.eclipse.stardust.engine.api.web.dms.DmsContentServlet DmsContentServlet} for
    ...
    * {@link org.eclipse.stardust.engine.api.runtime.DocumentManagementServiceException
    * DocumentManagementServiceException}.<br>
    ...
    * DocumentManagementServiceException} will be thrown.<br>
    ...
    *    #updateDocument(
    *    org.eclipse.stardust.engine.api.runtime.Document, boolean, String, String, boolean)
    ...
    * @deprecated since 7.0 use {@link
    *    #updateDocument(
    *    org.eclipse.stardust.engine.api.runtime.Document, byte[], String, boolean, String,
    *    String, boolean)
   ...
   /**
    * Initiates document content upload via {@link
    * org.eclipse.stardust.engine.api.web.dms.DmsContentServlet DmsContentServlet}. The
    * returned token should be used as relative URI for the content Servlet and will be
    * valid as long as the session associated with this service is alive.
    *
