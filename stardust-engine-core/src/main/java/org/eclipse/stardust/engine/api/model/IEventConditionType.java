...
public interface IEventConditionType extends IdentifiableElement, PluggableType
{
   ...
   void setActivityInstanceScope(boolean activityInstanceScope);

   void setProcessInstanceScope(boolean processInstanceScope);

   void setDisableOnMatch(boolean disablingOnMatch);
