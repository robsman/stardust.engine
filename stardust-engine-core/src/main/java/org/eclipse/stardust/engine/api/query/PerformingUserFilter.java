 ...
 * @version $Revision$
 */
public final class PerformingUserFilter implements FilterCriterion
{
    ...
    */
   public static final PerformingUserFilter CURRENT_USER =
         new PerformingUserFilter(CURRENT_USER_FILTER_TAG, -1);
   ...
   public PerformingUserFilter(long userOID)
   {
      this(CUSTOM_USER_FILTER_TAG, userOID);
   }

   private PerformingUserFilter(int filterKind, long userOID)
   {
