...
public class DocumentSetValidator implements DataValidator
{
   public BridgeObject getBridgeObject(AccessPoint point, String path, Direction direction)
   {
      Direction direction1 = null;

      Class currentType = DocumentSet.class;
      ...
      return new DocumentSetBridgeObject(currentType, direction1);
   }
    ...
    *
    */
   private static class DocumentSetBridgeObject extends BridgeObject
   {
      public DocumentSetBridgeObject(Class endClass, Direction direction)
      {
