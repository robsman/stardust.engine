 ...
 * @version $Revision$
 */
public class StringKeyBox extends GenericComboBox
{
   public StringKeyBox(boolean mandatory, boolean sorted)
   {
      this(StringKey.class, mandatory, sorted);
   }

   public StringKeyBox(Class keyType, boolean mandatory, boolean sorted)
   {
