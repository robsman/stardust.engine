 ...
 * @version $Revision$
 */
public class EventActionBean extends ActionBean implements IEventAction
{
   ...
   public EventActionBean(String id, String name)
   {
     super(id, name);
   }
   ...
   {
      super.checkConsistency(inconsistencies, "EventAction");
   }

   public EventActionContext getContext()
   {
      return EventActionContext.Event;
   }
