...
{
   static final String CONFIGURATION_VAR_PROVIDER = IConfigurationVariablesProvider.class.getName();
   
   void resetModelId(String modelId);
   String getModelId();
   
   void register(IConfigurationVariableDefinition definition);
