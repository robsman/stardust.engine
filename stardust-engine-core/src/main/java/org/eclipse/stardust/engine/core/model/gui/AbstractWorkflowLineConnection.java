...
import org.eclipse.stardust.engine.core.compatibility.diagram.LineConnection;


/**
 */
public abstract class AbstractWorkflowLineConnection extends LineConnection
{
    ...
    */
   public AbstractWorkflowLineConnection()
   {
      super();
   }
