...
/*      if (srcFile.isEmpty())
      {
         srcFile.add("C:\\development\\branches\\b_dev_5_2_surge_poc\\runtime-New_configuration\\test\\models\\Blabla.cwm");
      }
      
      if (tgtFile.isEmpty())
      {
         tgtFile.add("C:\\development\\branches\\b_dev_5_2_surge_poc\\runtime-New_configuration\\test\\models\\Blabla.xpdl");
      }*/
      ...
      for (int i = 0; i < srcFile.size(); i++)
      {
         ...
         if (!StringUtils.isEmpty(src) && !StringUtils.isEmpty(tgt))
         {
            try
            {
               ...
               XpdlUtils.convertCarnot2Xpdl(source, result);
            }
