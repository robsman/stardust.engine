...
public class UpdateDescriptor extends TableDescriptor
      implements ITypeDescriptor, FieldRefResolver
{
   ...
   public static UpdateDescriptor shallowCopy(UpdateDescriptor rhs)
   {
      UpdateDescriptor result = new UpdateDescriptor(rhs.getSchemaName(), QueryExtension.shallowCopy(rhs.qe));
   ...
   public static UpdateDescriptor from(Class type)
   {
      return from(null, type, null);
   }
   
   public static UpdateDescriptor from(Class type, String alias)
   {
      return from(null, type, alias);
   }

   public static UpdateDescriptor from(String schema, Class type)
   {
      return from(schema, type, null);
   }
   
   /**
    * @deprecated
    */
   public static UpdateDescriptor from(Class type, QueryExtension qe)
   {
      UpdateDescriptor result = new UpdateDescriptor(QueryExtension.shallowCopy(qe));
   ...
   public static UpdateDescriptor from(String schema, Class type, String alias)
   {
      UpdateDescriptor result = new UpdateDescriptor(schema, new QueryExtension());
   ...
   protected UpdateDescriptor(QueryExtension qe)
   {
      this(null, qe);
   }
   
   protected UpdateDescriptor(String schemaName, QueryExtension qe)
   {
      super(schemaName);
      this.qe = qe;
   }
      ...
      else
      {
         if ( !unresolvableTables.contains(field.getType().getTableName()))
         {
            throw new InternalException(MessageFormat.format(
                  "Table {0} for field {0} can not be resolved.",
   ...
   public UpdateDescriptor select(String attr)
   {
      return select(tdType.fieldRef(attr));
   }
   
   public UpdateDescriptor selectDistinct(String attr)
   {
      UpdateDescriptor query = select(tdType.fieldRef(attr));
   ...
   public UpdateDescriptor select(String attr1, String attr2)
   {
   ...
   public UpdateDescriptor select(String attr1, String attr2, String attr3)
   {
   ...
   public UpdateDescriptor select(String[] attributes)
   {
   ...
   public UpdateDescriptor select(Column[] columns)
   {
