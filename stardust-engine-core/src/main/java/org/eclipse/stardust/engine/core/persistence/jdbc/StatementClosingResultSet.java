...
import static org.eclipse.stardust.engine.core.persistence.jdbc.QueryUtils.closeStatement;
...
public class StatementClosingResultSet implements ResultSet
{
   ...
   public static ResultSet createManagedResultSet(Statement stmt, ResultSet rs)
   {
      return new StatementClosingResultSet(stmt, rs);
   }

   public StatementClosingResultSet(Statement stmt, ResultSet rs)
   {
      this.stmt = stmt;
      this.rs = rs;
   }
   ...
   // automatically generated methods delegating to the ResultSet rs
