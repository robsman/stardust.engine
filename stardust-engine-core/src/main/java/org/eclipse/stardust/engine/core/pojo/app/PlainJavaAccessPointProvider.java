...
public class PlainJavaAccessPointProvider implements AccessPointProvider
{
   ...
   public Iterator createIntrinsicAccessPoints(Map context, Map typeAttributes)
   {
      ...
      String constructorName = (String) context
            .get(PredefinedConstants.CONSTRUCTOR_NAME_ATT);
      try
      {
         Constructor ctor = Reflect.decodeConstructor(clazz, constructorName);
         result.putAll(JavaApplicationTypeHelper.calculateConstructorAccessPoints(ctor,
