...
public class UserWorktimeStatisticsResult extends UserWorktimeStatistics
{
   ...
   public UserWorktimeStatisticsResult(UserWorktimeStatisticsQuery query, Users users,
         Map<Long, WorktimeStatistics> worktimeStatictics)
   {
      super(query, users);

      this.worktimeStatistics.putAll(worktimeStatictics);
   }
}
