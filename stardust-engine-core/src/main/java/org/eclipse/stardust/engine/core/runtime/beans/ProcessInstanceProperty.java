...
public class ProcessInstanceProperty extends AbstractPropertyWithUser
{
   ...
   public static final FieldRef FR__OID = new FieldRef(ProcessInstanceProperty.class, FIELD__OID);
   public static final FieldRef FR__OBJECT_OID = new FieldRef(ProcessInstanceProperty.class, FIELD__OBJECT_OID);
   public static final FieldRef FR__NAME = new FieldRef(ProcessInstanceProperty.class, FIELD__NAME);
   public static final FieldRef FR__TYPE_KEY = new FieldRef(ProcessInstanceProperty.class, FIELD__TYPE_KEY);
   public static final FieldRef FR__NUMBER_VALUE = new FieldRef(ProcessInstanceProperty.class, FIELD__NUMBER_VALUE);
   public static final FieldRef FR__STRING_VALUE = new FieldRef(ProcessInstanceProperty.class, FIELD__STRING_VALUE);
