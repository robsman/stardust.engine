...
public class UserGroupProperty extends AbstractPropertyWithUser
{
   ...
   public static final FieldRef FR__OID = new FieldRef(UserGroupProperty.class, FIELD__OID);
   public static final FieldRef FR__OBJECT_OID = new FieldRef(UserGroupProperty.class, FIELD__OBJECT_OID);
   public static final FieldRef FR__NAME = new FieldRef(UserGroupProperty.class, FIELD__NAME);
   public static final FieldRef FR__TYPE_KEY = new FieldRef(UserGroupProperty.class, FIELD__TYPE_KEY);
   public static final FieldRef FR__NUMBER_VALUE = new FieldRef(UserGroupProperty.class, FIELD__NUMBER_VALUE);
   public static final FieldRef FR__STRING_VALUE = new FieldRef(UserGroupProperty.class, FIELD__STRING_VALUE);
   ...
   public static final String[] usergrp_prp_idx1_INDEX = new String[]{FIELD__OBJECT_OID};
   public static final String[] usergrp_prp_idx2_INDEX =
         new String[]{FIELD__TYPE_KEY, FIELD__NUMBER_VALUE};
   public static final String[] usergrp_prp_idx3_INDEX =
         new String[]{FIELD__TYPE_KEY, FIELD__STRING_VALUE};
   public static final String[] usergrp_prp_idx4_UNIQUE_INDEX = new String[]{FIELD__OID};

   public UserGroupProperty()
   {
   }

   public UserGroupProperty(long user, String name, Object value)
   {
