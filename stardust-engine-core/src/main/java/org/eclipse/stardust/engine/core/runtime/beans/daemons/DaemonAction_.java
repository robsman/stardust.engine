 ...
 * @version $Revision$
 */
public class DaemonAction_ extends SecurityContextAwareAction
{
   private static final String INVALID_ACTION = "invalid_action";
   public static final Logger daemonLogger = RuntimeLog.DAEMON;   
   
   private static final Logger trace = LogManager.getLogger(DaemonAction_.class);
   ...
   public DaemonAction_(DaemonCarrier carrier)
   {
      super(carrier);
   ...
   private static class ExecuteDaemonAction extends SecurityContextAwareAction
   {
      ...
      public Object execute()
      {
         ...
         try
         {
            ...
            {
               System.err.println("## concurrency " + carrier.getType() + " / " + daemon);
            ...
            {
               System.err.println("## exception " + carrier.getType() + " / " + daemon);
            ...
            try
            {
               System.err.println("## excecute " + carrier.getType() + " / " + daemon);
      ...
      private void acquireMemoryLock()
      {
         synchronized (locks)
         {
            ...
            System.err.println("#### check type " + carrier.getType() + " / " + locks.contains(type) + " / " + daemon);
