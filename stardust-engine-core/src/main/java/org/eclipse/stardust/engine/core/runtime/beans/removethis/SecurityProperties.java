...
public final class SecurityProperties
{
   ...
   @ConfigurationProperty(status = Status.Stable, useRestriction = UseRestriction.Public)
   public static final String AUTHORIZATION_MODE_PROPERTY =
    ...
    *
    */
   public static final String AUTHENTICATION_CONFIGURATION_NAME_PROPERTY =
         "Security.Authentication.ConfigurationName";

   public static final String AUTHENTICATION_PRINCIPAL_PROVIDER_PROPERTY =
         "Security.Authentication.PrincipalProvider";

   /** The class to filter out as the principal used. */
   public static final String AUTHENTICATION_PRINCIPAL_CLASS_PROPERTY =
         "Security.Authentication.PrincipalClass";

   /** name of the option for the maximum number of login retries option */
   public static final String MAXIMUM_LOGIN_RETRIES_PROPERTY =
         "Security.Authentication.MaximumNumberLoginRetries";
   /** name of the option for the invalidation time in minutes option */
   public static final String INVALIDATION_TIME_PROPERTY =
         "Security.Authentication.InvalidationTimeInMinutes";

   @ConfigurationProperty(status = Status.Stable, useRestriction = UseRestriction.Public)
   @PropertyValueType(ExternalLoginProvider.class)
   public static String AUTHENTICATION_SERVICE_PROPERTY =
         "Security.Authentication.LoginService";

   @ConfigurationProperty(status = Status.Stable, useRestriction = UseRestriction.Public)
   @PropertyValueType(DynamicParticipantSynchronizationProvider.class)
   public static String AUTHORIZATION_SYNC_CLASS_PROPERTY =
         "Security.Authorization.SynchronizationProvider";
   @ConfigurationProperty(status = Status.Stable, useRestriction = UseRestriction.Public)
   @PropertyValueType(DynamicParticipantSynchronizationStrategy.class)
   public static final String AUTHORIZATION_SYNC_STRATEGY_CLASS_PROPERTY =
         "Security.Authorization.SynchronizationStrategy";

   public static final String AUTHORIZATION_SYNC_ADMIN_PROPERTY =
         "Security.Authorization.SynchronizeOnAdministrationSession";

   public static final String AUTHORIZATION_SYNC_LOGIN_PROPERTY =
         "Security.Authorization.SynchronizeOnLogin";
   public static final String AUTHORIZATION_SYNC_LOAD_PROPERTY =
         "Security.Authorization.SynchronizeOnLoad";

   /** Enables tracing for user/userGroup synchronization with external registry. */
   public static final String AUTHORIZATION_SYNC_TRACE_PROPERTY =
      "Security.Authorization.TraceSynchronization";

   /**
    * Sets the validTo property of an user/userGroup to current date (invalidates it)
    * in case that it does not exitst in external registry.
    */
   public static final String AUTHORIZATION_SYNC_INVALIDATE_NONEXISTING_PARTICIPANTS_PROPERTY =
         "Security.Authorization.InvalidateNonexistingParticipants";

   public static final String AUTHORIZATION_SYNC_CONDITIONAL_PERFORMER_PROPERTY =
         "Security.Authorization.SynchronizeConditionalPerformer";

   public static final String AUTHORIZATION_SYNC_STRATEGY_USER_SYNC_TIMEOUT =
      "Security.Authorization.TimebasedSynchronizationStrategy.UserSyncTimeout";

   public static final String AUTHORIZATION_SYNC_STRATEGY_USER_GROUP_SYNC_TIMEOUT =
      "Security.Authorization.TimebasedSynchronizationStrategy.UserGroupSyncTimeout";

   // todo: rename or remove
   public static final String AUTHENTICATION_IMPLICIT_CLIENT_IDENTITY_PROPERTY =
         "DefaultJAASAuthenticatedBeanFactory.ImplicitClientIdentity";
   ...
   {
      return AUTHENTICATION_MODE_PRINCIPAL.equalsIgnoreCase(parameters.getString(
            AUTHENTICATION_MODE_PROPERTY));
   }

   public static boolean isImplicitAuthentication(Parameters parameters)
   {
      return AUTHENTICATION_MODE_IMPLICIT.equalsIgnoreCase(parameters.getString(
            AUTHENTICATION_MODE_PROPERTY));
   }
