...
public class AT3_0_2from2_0_0RuntimeJob extends DbmsAwareRuntimeUpgradeJob
{
   private static final Logger trace = LogManager
         .getLogger(AT3_0_2from2_0_0RuntimeJob.class);
   ...
   private static final Version VERSION = Version.createFixedVersion(3, 0, 2);

   protected AT3_0_2from2_0_0RuntimeJob()
   {
      super(new DBMSKey[] {
