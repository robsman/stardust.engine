 ...
 *    stephan.born (SunGard CSA LLC) - adapted for SD upgrade job
 *******************************************************************************/
...
public class AT4_0_0from3_1_0RuntimeJob extends DbmsAwareRuntimeUpgradeJob
{
   private static final Logger trace = LogManager
         .getLogger(AT4_0_0from3_1_0RuntimeJob.class);
   ...
   private AT4_0_0from3_1_0RuntimeJob runtimeJob;

   AT4_0_0from3_1_0RuntimeJob()
   {
      super(new DBMSKey[] {
