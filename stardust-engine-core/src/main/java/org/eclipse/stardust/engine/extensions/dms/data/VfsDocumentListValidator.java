...
/**
 * Validator for document lists
 */
// TODO (ab) implement 
public class VfsDocumentListValidator implements DataValidator
{
...
//      Class currentType = List.class;
      ...
      else
      {
         ...
         if (xPathMap.containsXPath(pathWithoutIndexes))
         {
            ...
            {
               return new FallbackBridgeObject(Document.class, direction, structuredBridgeObject.getEndClass());
            }
            else
            {
