...
public class ConstantsDataMappingsTest
{
   ...
   @ClassRule
   public static final TestClassSetup testClassSetup = new TestClassSetup(ADMIN_USER_PWD_PAIR, ForkingServiceMode.NATIVE_THREADING, CONSTANT_MODEL_NAME, ENUM_MODEL_NAME);
