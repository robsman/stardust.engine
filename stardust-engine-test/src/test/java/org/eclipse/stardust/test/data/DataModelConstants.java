...
public class DataModelConstants
{
   ...
   /**
    * DataId for 'My Struct'
    */
   /* package-private */ static final String MY_STRUC_DATA_ID = "MyStruct";

   /**
    * an in data path for 'My Struct'
    */
   /* package-private */ static final String MY_STRUC_IN_DATA_PATH = "MyStructIN";

   /**
    * an out data path for 'My Struct'
    */
   /* package-private */ static final String MY_STRUC_OUT_DATA_PATH = "MyStructOUT";
