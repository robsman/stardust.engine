...
/**
 * <p>
 * Tests synchronization of workflow document data having a document type assigned and jcr documents in case of deleted /documentTypes folder.
 * The /documentTypes folder in the repository is removed before each test and resynced on demand when accessed.
 * </p>
 *
 * @author Roland.Stamm
 * @version $Revision: 74449 $
 */
public class DmsSyncTypedDocumentEmptyRepositoryTest
{
   ...
   @ClassRule
   public static final TestClassSetup testClassSetup = new TestClassSetup(ADMIN_USER_PWD_PAIR, ForkingServiceMode.NATIVE_THREADING, DMS_SYNC_MODEL_NAME);
   ...
   public void setup()
   {
      ...
      // Removes synced document types from the repository, they will be resynced on access.
      dms.removeFolder("/", true);
