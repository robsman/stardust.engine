 ...
 * Using a non default repository.
 * </p>
 *
 * @author Roland.Stamm
 * @version $Revision: 66697 $
 */
public class DmsSyncTypedDocumentMultiRepositoryTest
{
   ...
   {
      DocumentManagementService dms = sf.getDocumentManagementService();
      dms.setDefaultRepository(null);
      dms.unbindRepository(RepositoryTestUtils.TEST_REPO_ID);
   }
