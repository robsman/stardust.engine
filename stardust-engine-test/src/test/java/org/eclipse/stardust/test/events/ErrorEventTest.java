...
public class ErrorEventTest
{
   ...
   public void testThrownErrorEventIsReceivedByCallingActivity() throws InterruptedException, TimeoutException
   {
      ...
      ProcessInstance rootProcess = wfs.startProcess("RootProcess",
      ...
      // error handling should be activated
      aiStateChangeBarrier.awaitForId(rootProcess.getOID(), "AwaitError");
      ...
      sf.getWorkflowService().abortProcessInstance(failingProcess.getOID(), AbortScope.SubHierarchy);
