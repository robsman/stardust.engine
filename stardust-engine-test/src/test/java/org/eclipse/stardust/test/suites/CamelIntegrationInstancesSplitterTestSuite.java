...
import static org.eclipse.stardust.test.camel.splitter.InstancesSplitterTest.MODEL_ID;
...
import org.eclipse.stardust.test.camel.splitter.InstancesSplitterTest;
 ...
 * especially with <i>IPP</i>'s <i>Camel</i> {@link InstancesSplitter}.
 * </p>
 *
...
@RunWith(Suite.class)
@SuiteClasses({
                 InstancesSplitterTest.class
              })
public class CamelIntegrationInstancesSplitterTestSuite extends AbstractCamelIntegrationTest
{
   @ClassRule
