...
public interface IWorkflowService {
    ...
    public org.eclipse.stardust.engine.api.ws.ProcessInstanceXto spawnPeerProcessInstance(
        ...
        java.lang.Boolean abortProcessInstance,
        @WebParam(name = "spawnMode", targetNamespace = "http://eclipse.org/stardust/ws/v2012a/api")
        org.eclipse.stardust.engine.api.ws.SpawnModeXto spawnMode,
        @WebParam(name = "comment", targetNamespace = "http://eclipse.org/stardust/ws/v2012a/api")
        java.lang.String comment
    ) throws BpmFault;
