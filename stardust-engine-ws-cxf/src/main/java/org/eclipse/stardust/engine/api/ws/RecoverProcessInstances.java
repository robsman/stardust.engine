...
@XmlRootElement(name = "recoverProcessInstances")
public class RecoverProcessInstances {

    @XmlElement(required = true, nillable = true)
    protected RecoverProcessInstances.OidsXto oids;
     ...
     * @return
     *     possible object is
     *     {@link RecoverProcessInstances.OidsXto }
     *     
     */
    public RecoverProcessInstances.OidsXto getOids() {
        return oids;
    }
     ...
     *     
     */
    public void setOids(RecoverProcessInstances.OidsXto value) {
        this.oids = value;
    }
