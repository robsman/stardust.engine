 ...
 * 2014-01-09T10:24:12.352+01:00
 * Generated source version: 2.6.1
 * 
 */
@WebServiceClient(name = "StardustBpmServices", 
                  wsdlLocation = "file:/C:/development/TRUNK/product_trunk/stardust/engine/stardust-engine-ws-cxf/src/main/resources/META-INF/wsdl/StardustBpmService.wsdl",
...
public class StardustBpmServices extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/development/TRUNK/product_trunk/stardust/engine/stardust-engine-ws-cxf/src/main/resources/META-INF/wsdl/StardustBpmService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(StardustBpmServices.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/development/TRUNK/product_trunk/stardust/engine/stardust-engine-ws-cxf/src/main/resources/META-INF/wsdl/StardustBpmService.wsdl");
        }
        WSDL_LOCATION = url;
    }
