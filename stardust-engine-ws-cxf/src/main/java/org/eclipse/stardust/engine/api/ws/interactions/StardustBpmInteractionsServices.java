 ...
 * 2013-03-05T11:35:35.892+01:00
 * Generated source version: 2.6.1
 * 
 */
@WebServiceClient(name = "StardustBpmInteractionsServices", 
                  wsdlLocation = "file:/C:/development/product/stardust/engine/stardust-engine-ws-cxf/src/main/resources/META-INF/wsdl/StardustBpmInteractionsService.wsdl",
...
public class StardustBpmInteractionsServices extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/development/product/stardust/engine/stardust-engine-ws-cxf/src/main/resources/META-INF/wsdl/StardustBpmInteractionsService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(StardustBpmInteractionsServices.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/development/product/stardust/engine/stardust-engine-ws-cxf/src/main/resources/META-INF/wsdl/StardustBpmInteractionsService.wsdl");
        }
        WSDL_LOCATION = url;
    }
