 ...
 * 2014-08-28T15:51:10.801+02:00
 * Generated source version: 2.6.1
 * 
 */
@WebServiceClient(name = "StardustBpmInteractionsServices", 
                  wsdlLocation = "file:/C:/development/Versions/b_dev_8_1_x/stardust/engine/stardust-engine-ws-cxf/src/main/resources/META-INF/wsdl/StardustBpmInteractionsService.wsdl",
...
public class StardustBpmInteractionsServices extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/development/Versions/b_dev_8_1_x/stardust/engine/stardust-engine-ws-cxf/src/main/resources/META-INF/wsdl/StardustBpmInteractionsService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(StardustBpmInteractionsServices.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/development/Versions/b_dev_8_1_x/stardust/engine/stardust-engine-ws-cxf/src/main/resources/META-INF/wsdl/StardustBpmInteractionsService.wsdl");
        }
        WSDL_LOCATION = url;
    }
