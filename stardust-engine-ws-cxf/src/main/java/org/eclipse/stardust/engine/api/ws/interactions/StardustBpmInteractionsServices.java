 ...
 * 2015-06-22T13:08:05.533+02:00
 * Generated source version: 2.6.1
 * 
 */
@WebServiceClient(name = "StardustBpmInteractionsServices", 
                  wsdlLocation = "file:/C:/development/Products/IPP/git/stardust/engine/stardust-engine-ws-cxf/target/codegen/wsdl/StardustBpmInteractionsService.wsdl",
...
public class StardustBpmInteractionsServices extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/development/Products/IPP/git/stardust/engine/stardust-engine-ws-cxf/target/codegen/wsdl/StardustBpmInteractionsService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(StardustBpmInteractionsServices.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/development/Products/IPP/git/stardust/engine/stardust-engine-ws-cxf/target/codegen/wsdl/StardustBpmInteractionsService.wsdl");
        }
        WSDL_LOCATION = url;
    }
